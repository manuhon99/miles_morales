...
export default function Home() {
  return (
        ...
        <nav className={styles.navbar}>
            <div className={styles.navmenu}>
                <div className={styles.logo}>
                    <a href=""><img style={{maxWidth: '96px'}} src={require('../img/logo-spiderman.png')} onload="SVGInject(this)" /></a>
                </div>
                <ul className={styles.navlist}>
                    <li><a href="" className={styles.navlink} >Home</a></li>
                    <li><a href="" className={styles.navlink} >Story</a></li>
                    <li><a href="" className={styles.navlink} >Wallpapers</a></li>
                    <li><a href="" className={styles.navlink}  style={{color:'EA1D22', fontStyle: 'italic'}}>#BeYourself</a></li>
                </ul>
            </div>
            <div className={styles.navsocial}>
                ...
                <img src="svg/icon-twitter.svg" className={styles.mr2} onload="SVGInject(this)" />
            </div>
            <div className={styles.bxmr3}/>
    ...
    <section className={styles.bglines}>
        <img src={'svg/svg-lines.svg'} onload='SVGInject(this)' />
    </section>

    <section className={styles.container}>
        <div className={styles.containeritem1}>
            <p className={styles.px1item1}>
                <img src={'svg/spiderman-text.svg'} onload='SVGInject(this)' />
            </p>
            
            <p className={styles.my2item2}>
            ...
            <p className={styles.mt1flexitem3}>
                <span><a href={""} className={styles.btn}>Pre-order now</a></span>
                <span><a href={""} className={styles.ml2btnsecondary} id='reverse'>watch the teaser</a></span>
            </p>
            <p className={styles.mt2fleXalignitemscenteritem4}>
                <img src={'svg/ps.svg'} className={styles.wauto} style={{cursor: 'pointer'}} onload="SVGInject(this)" />
                <img src={"svg/marvel.svg"} className={styles.ml2wauto} style={{cursor: 'pointer'}} onload="SVGInject(this)" />
            </p>
        </div>
        <div className={styles.containeritem2item5}>
            <div className={styles.jstilt}>
                <img src={'svg/spider-man.svg'} className={styles.spiderman} onload='SVGInject(this)' />
            </div>
